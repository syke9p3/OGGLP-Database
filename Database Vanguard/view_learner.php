    ...
    <form method="post">
        <div class="row">
            ...
            <div class="col-md-2">
                <table>
                    <tr>
                        <td class="stud-id d-none"></td>
                        <td class="stud-name d-none"></td>
                        <td class="stud-gender d-none"></td>
                        <td class="stud-bday d-none"></td>
                        <td class="stud-address d-none"></td>
                        <td class="stud-homeNum d-none"></td>
                        <td class="stud-cellNum d-none"></td>
                        <td class="stud-otherNum d-none"></td>
                        <td class="stud-email d-none"></td>
                        <td class="stud-altEmail d-none"></td>
