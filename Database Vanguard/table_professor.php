...
<div id="viewModal" class="modal fade">
	<div class="modal-dialog modal-fullscreen">
		<div class="modal-content modal-fullscreen">
			...
			<?php include "view_professor.php" ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form class="form" action="deleteRecord.php" method="POST">
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
					<input type="submit" name="delete_professor" class="btn btn-danger" value="Delete">
				</div>
			</form>
		</div>
	</div>
...
<script>
	$(document).ready(function() {
		...
		$('.viewModalBtn').on('click', function(e) {
			...
			$(".prof-name").append($name_val);
			$(".prof-email").append($name_val.toLowerCase().replace(/ /g, ''));
			$(".prof-id").append($id_val);
