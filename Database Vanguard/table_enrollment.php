				...
				<div class="modal-body">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="form-select form-control" name="gender" placeholder="Select Learner" required>
									...
									?>
											<option value="<?php echo $i ?>"><?php echo $option['learner_name'] ?></option>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="form-select form-control" name="gender" placeholder="Select Learner" required>
									...
									?>
											<option value="<?php echo $i ?>"><?php echo $option['course_name'] ?>
											</option>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="form-select form-control" name="gender" placeholder="Select Learner" required>
									...
									?>
											<option value="<?php echo $i ?>"><?php echo $option['professor_name'] ?></option>
					...
					<div class="col-md-6">
						<div class="form-group">
								...
								<input type="text" class="form-control" name="dateStart" placeholder=" yyyy-mm-dd">
							</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
								<label for="id" class="form-label">Date End</label>
								<input type="text" class="form-control" name="dateEnd" placeholder=" yyyy-mm-dd">
							</div>
					</div>
					</div>
